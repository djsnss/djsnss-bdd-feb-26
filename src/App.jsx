...
function App() {
  ...
  useEffect(() => {
    ...
    return () => window.removeEventListener('donation-dismissed', handleDonationDismissed);
  }, []);
  ...
  return (
    <div className="app-container relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center">
        <div
          ...
          style={{
            ...
            boxShadow: "0 8px 40px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.08)",
            padding: "28px 48px 32px",
          }}
        >
          {/* DJS NSS Logo — top left corner */}
          <div
          ...
          <div className="flex flex-col items-center min-w-max">
            ...
            {/* Tubes — explicit width matches pipe SVG exactly */}
            <div
              className="flex items-end mt-[-8px]"
              style={{
                width: DEPARTMENTS.length * TUBE_WIDTH + (DEPARTMENTS.length - 1) * GAP,
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 px-5 py-2.5 text-white font-bold rounded-xl shadow-lg transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
        style={{
